...
import { Sliders, SwatchBook } from "lucide-react";
...
import { PantonePanel } from "./pantone-panel";
...
const Editor: React.FC<EditorProps> = ({ themePromise }) => {
  ...
  const pantonePanelOpen = usePreferencesStore((state) => state.pantonePanelOpen);
          ...
          <div className="size-full flex-1 overflow-hidden">
            <Tabs defaultValue="controls" className="h-full">
              <TabsList className="w-full rounded-none">
                ...
                <TabsTrigger value="pantone" className="flex-1">
              ...
              <TabsContent value="pantone" className="mt-0 h-[calc(100%-2.5rem)]">
                <div className="flex h-full flex-col">
                  <PantonePanel />
                </div>
              </TabsContent>
      ...
      <div className="relative isolate flex flex-1 overflow-hidden">
        <div className="size-full">
          <ResizablePanelGroup orientation="horizontal" className="isolate">
            ...
            <ResizableHandle />
            <ResizablePanel defaultSize={pantonePanelOpen ? "50%" : "70%"}>
              <div className="flex h-full flex-col">
            ...
            {pantonePanelOpen && (
              <>
                <ResizableHandle />
                <ResizablePanel defaultSize="20%" minSize="15%" maxSize="35%" className="z-1">
                  <div className="relative isolate flex h-full flex-1 flex-col overflow-hidden">
                    <PantonePanel />
                  </div>
                </ResizablePanel>
